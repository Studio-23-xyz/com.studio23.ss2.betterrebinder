...
{
    [CustomEditor(typeof(Rebinder))]
    public class RebinderInspectorEditor : UnityEditor.Editor
    {
        protected void OnEnable()
        {
            ...
            m_overrideActionLabel = serializedObject.FindProperty("_overrideActionLabel");
            m_overrideActionLabelText = serializedObject.FindProperty("_overrideActionLabelText");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(m_overrideActionLabel);
                EditorGUILayout.PropertyField(m_overrideActionLabelText);
        ...
        private SerializedProperty m_overrideActionLabel;
        private SerializedProperty m_overrideActionLabelText;
